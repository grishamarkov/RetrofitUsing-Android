...
public class GamesFragment extends CustomRowsFragment {
    ...
    public void setSubCategories(Categories allCategories) {
        ...
        for (int i=0; i<categories.size(); i++) {
            ...
            if (parent == null) {
                if (category.getTitle().equalsIgnoreCase(GamesFragment.TITLE))
                    me = category;
                continue;
            }

            if (parent.getTitle().equalsIgnoreCase(GamesFragment.TITLE)) {

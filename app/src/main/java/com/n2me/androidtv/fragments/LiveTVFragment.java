...
public class LiveTVFragment extends CustomRowsFragment {

    private static final String TAG = LiveTVFragment.class.getSimpleName();
    private static final String TITLE = "Live TV";
    ...
    public void setSubCategories(Categories allCategories) {
        ...
        for (int i=0; i<categories.size(); i++) {
            ...
            if (parent == null) {
                if (category.getTitle().equalsIgnoreCase(LiveTVFragment.TITLE))
                    me = category;
                continue;
            }

            if (parent.getTitle().equalsIgnoreCase(LiveTVFragment.TITLE)) {

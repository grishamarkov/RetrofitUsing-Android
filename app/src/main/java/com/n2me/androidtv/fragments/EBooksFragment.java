...
public class EBooksFragment extends CustomRowsFragment {

    private static final String TAG = EBooksFragment.class.getSimpleName();
    private static final String TITLE = "Ebooks";
    ...
    public void setSubCategories(Categories allCategories) {
        ...
        for (int i=0; i<categories.size(); i++) {
            ...
            if (parent == null) {
                if (category.getTitle().equalsIgnoreCase(EBooksFragment.TITLE))
                    me = category;
                continue;
            }

            if (parent.getTitle().equalsIgnoreCase(EBooksFragment.TITLE)) {

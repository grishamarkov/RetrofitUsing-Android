...
public class EventsFragment extends CustomRowsFragment {
    ...
    public void setSubCategories(Categories allCategories) {
        ...
        for (int i=0; i<categories.size(); i++) {
            ...
            if (parent == null) {
                if (category.getTitle().equalsIgnoreCase(EventsFragment.TITLE))
                    me = category;
                continue;
            }

            if (parent.getTitle().equalsIgnoreCase(EventsFragment.TITLE)) {
